...
namespace Movie.Management.Api.Controllers
{
    ...
    public class MoviesController : ControllerBase
    {
        ...
        /// </summary>
        /// <param name="page">Movies page number\
        /// Número da página de filmes</param>
        /// <param name="records">Number of movies per pagination\
        ...
        [HttpGet("page/{page:int}/records/{records:int}")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        [ProducesResponseType(StatusCodes.Status500InternalServerError)]
        public async Task<ActionResult<MovieResponsePaginatedViewModel>> GetAsync(int page = 1, int records = 10)
        {
            try
            {
                var resultOperation = await _movieService.GetMoviesPaginated(page, records);
                ...
                var responseVM = _mapper.Map<MovieResponsePaginatedViewModel>(resultOperation.Result);
